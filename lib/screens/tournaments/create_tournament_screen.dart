  ...
  Future<void> _createTournament() async {
    ...
    if (_hostPosition.isEmpty) {
      showDialog(
        ...
        builder: (context) => AlertDialog(
          title: const Text('오류'),
          content: const Text('주최자 포지션을 선택해주세요.'),
          actions: [
            TextButton(
    ...
    try {
      ...
      if (newTournament != null) {
        ...
        if (mounted) {
          Navigator.of(context).pop(true);  // 생성 성공 시 true 반환
        }
        ...
        if (mounted) {
          ...
          showDialog(
            context: context,
            builder: (context) => AlertDialog(
              title: const Text('생성 실패'),
              content: const Text('내전 생성에 실패했습니다. 다시 시도해주세요.'),
              actions: [
                TextButton(
                  onPressed: () => Navigator.of(context).pop(),
                  child: const Text('확인'),
